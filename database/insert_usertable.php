  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content rounded-4 shadow">
      ...
      <div class="modal-body p-5 pt-0">
        <form method="post" action="insert_usertable_backend.php">
     ...
     <input type="email" class="form-control rounded-3" id="floating3" name ="email">
          ...
          <div class="form-floating mb-3">
            <input type="date" class="form-control rounded-3" id="floating4"   name ="dob">
            <label for="floating4">Date of birth</label>
          </div>
          <div class="form-floating mb-3">
            <input type="password" class="form-control rounded-3" id="floating5"    name="pass1">
            <label for="floating5"> Password</label>
          </div>
          <div class="form-floating mb-3">
            <input type="password" class="form-control rounded-3" id="floating6"    name="pass2">
            <label for="floating5">Confirm Password</label>
          </div>
