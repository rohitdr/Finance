...
$showfulldata ="select * from contact_us where Id='$id'";
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content rounded-4 shadow">
      ...
      <div class="modal-body p-5 pt-0">
        <form method="post" action="edit_reason_backend.php?id=<?php  echo $id; ?>">
        ...
        <div class="form-floating mb-3">
            <input type="text" class="form-control rounded-3" id="floating2"  value="<?php echo $sfdrow['number'];  ?>"  name="number">
     ...
     <input type="email" class="form-control rounded-3" id="floating3" value="<?php echo $sfdrow['email'];  ?>"  name ="email">
          ...
          <div class="form-floating mb-3">
            <input type="text" class="form-control rounded-3" id="floating5"  value="<?php echo $sfdrow['reason'];  ?>"  name="reason">
