...
<html lang="en">
  <head>
    ...
    <title>Educational_Loan -- financial_advisor</title>
...
<div class="container text-center text-white m-2 mb-0">
  <h1 class="">Education Loan Application</h1>
...
<div class="row ">
 ...
 <form method="post" action="Educational_loan_backend.php">
  <div class="row mt-2">
...
<div class="container col-xxl-10 px-4 py-1 mb-0 reveal personal mt-0 ">
  ...
  <div class="form-group  mt-2">
    ...
    <input type="text" class="form-control" id="inputAddress" name="idnumber"placeholder="ID Number">
  </div>
  <div class="row  mt-3">
