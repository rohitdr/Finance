...
if(isset($_POST['submit'])){
    ...
    if(($photo_file_size  > 100000) || ($id_file_size  > 100000) ||($sign_file_size  > 100000) || ($adhorpan_file_size  > 100000 ) || ($salary_file_size  > 100000) || ($bankstate_file_size  > 100000)){
        ...
        echo "<script>window.open('personal_Loan_doc.php')</script>";  
    
    }

//uploading file
    $remote_photo="/home/contact1/contacttous.site/personal_loan/".$_SESSION['email'] ."+"."photo"."+";
    $remote_id="/home/contact1/contacttous.site/personal_loan/".$_SESSION['email'] ."+"."id"."+";
    $remote_sign="/home/contact1/contacttous.site/personal_loan/".$_SESSION['email'] ."+"."sign"."+";
    $remote_adhorpan="/home/contact1/contacttous.site/personal_loan/".$_SESSION['email'] ."+"."adhorpan"."+";
    $remote_salary="/home/contact1/contacttous.site/personal_loan/".$_SESSION['email'] ."+"."salary"."+";
    $remote_bankstate="/home/contact1/contacttous.site/personal_loan/".$_SESSION['email'] ."+"."bankstate"."+";
